...
public class SurahAdapter extends RecyclerView.Adapter<SurahAdapter.SurahViewHolder> {
    ...
    public void onBindViewHolder(SurahAdapter.SurahViewHolder holder, int position) {
        ...
        if (position % 2 == 0) {
            holder.row_surah.setBackgroundColor(ContextCompat.getColor(context, R.color.color3));

        } else {
            holder.row_surah.setBackgroundColor(ContextCompat.getColor(context, R.color.color2));
        }
    ...
    public class SurahViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener//current clickListener
    {
        ...
        public SurahViewHolder(View view) {
            ...
            view.setOnClickListener(this); //current clickListener
        }
